...
const hasSky = () => {
    //return !window.matchMedia('(width <= 1276px)').matches; // not match
    return window.innerWidth >= 1276;
}

const hasBigSky = () => {
    //return !window.matchMedia('(width <= 1600px)').matches;
...
(function() {
    ...
    const adSlot1 = document.getElementById('ad-slot-1'); // 300x250
    const adSlot2 = document.getElementById('ad-slot-2'); // 728x90
    const adSlot3 = document.getElementById('ad-slot-3'); // 300x600
    ...
    function init() {
        ...
        // TODO: 300x250
        const placement1 = createPlacement(adSlot1, { width: 300, height: 250 });
        ...
        // TODO:
        createSlot('1', placement1, container1, sizes1, {
            data:[
                /*
                {
                  id: '4_1',
        ...
        // TODO: Sky 160x600 or 300x600
        if(hasSky()) {

            const placement3 = createPlacement(adSlot3, hasBigSky() ? { width: 300, height: 600 } : { width: 160, height: 600 });
            ...
            if(hasBigSky()) {
                sizes3.push({width: 300, height: 250});
                sizes3.push({width: 300, height: 600});
            }
            ...
            createSlot('3', placement3, container3, sizes3, {
                data:[
                    /*
                    {
                      id: '4_3',
                     ...
                     */
                    {
                        id:'7_3',
                        adServer: {
                            url:'/23313035219/test_display_ad_unit_side'
                        },
                        frequency:{
                            type:'REQUEST',
                            value:1,
                    ...
                    },
                    {
                        id: '6_3',
                        adServer: {
                            url: '/21925505877/test_display_ad_unit_side'
                        },
                        frequency:{
                            type:'REQUEST',
                            value:1,
        ...
        // TODO:
        const slots = getRegisteredSlots();
        const displayAdManagers = new Map();
        for(const [key, value] of slotsMap) {
          console.log('dsp > ', key, value);
          const slotDef = value;
